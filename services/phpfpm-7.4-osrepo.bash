...
packages=(php7.4-cli php-pear php-php-gettext php-phpseclib php-tcpdf php7.4-bz2 php7.4-common php7.4-curl php7.4-gd php7.4-json php7.4-mbstring php7.4-mysql php7.4-readline php7.4-xml php7.4-zip php7.4-mysqlnd php7.4-bcmath php7.4-intl php7.4-soap)
